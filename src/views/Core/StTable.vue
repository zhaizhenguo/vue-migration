...
export default {
  ...
  props: {
    ...
    showOperationBtnCheck: {
      // 是否显示操作列查看按钮
      type: Boolean,
      default: false,
    },
    showOperationBtnEdit: {
      // 是否显示操作列编辑按钮
      type: Boolean,
      default: true,
    },
    showOperationBtnDelete: {
      // 是否显示操作列编辑按钮
      type: Boolean,
      default: true,
    },
